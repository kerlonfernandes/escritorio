        ...
        if (isset($documentos['name']) && is_array($documentos['name'])) {
            foreach ($documentos['name'] as $index => $fileName) {
                if ($documentos['error'][$index] == 0) {
                    ...
                    if ($fileSize > 100000000) { // Limitar o tamanho do arquivo para 50MB
            ...
            if ($documentos['error'] == 0) {
                ...
                if ($fileSize > 100000000) { // Limitar o tamanho do arquivo para 5MB
                    throw new Exception('O arquivo é muito grande. O tamanho máximo permitido é 100MB.');
                }
